...
let add c1 c2 = Tuple.add c1 c2 (*let c = Tuple.add c1 c2 in init (r c, g c, b c)*)
...
let sub c1 c2 = Tuple.sub c1 c2 (*let c = Tuple.sub c1 c2 in init (r c, g c, b c)*)
...
let mul c1 c2 = Array.map2 ( *. ) c1 c2
